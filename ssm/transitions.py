...
#    pass
    ...
    def log_transition_matrix(self):
        ...
        for i in range(K):
            for j in range(K):
                ...
                #i is the likelihood state corresponding to hardcoded state ell_labels[i]
    ...
    def m_step(self, expectations, datas, inputs, masks, tags, optimizer="adam", num_iters=5, **kwargs):
        """
